...
Coeff.v(1,1)=2;     % Setting up the degrees of freedom for t distribution at state 1
Coeff.v(1,2)=5;     % Setting up the degrees of freedom for t distribution at state 2
