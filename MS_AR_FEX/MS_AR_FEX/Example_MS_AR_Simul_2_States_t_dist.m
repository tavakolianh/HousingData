...
addpath('C:\Users\Emertat\Documents\cooldisk\Matlab\Code\MS_AR_FEX\MS_AR_FEX');
...
Coeff.v(1,1)= 5;   % Setting up the mean constant at State 1
Coeff.v(1,2)= 15;   % Setting up the mean constant at State 2

Coeff.AR(:,1)=[ .2   .1 -.1  .2];   % Setting up the AR param at State 1 (you can increase/decrease it as wanted)
Coeff.AR(:,2)=[-.15 -.1  .1 -.2];   % Setting up the AR param at State 2 (you can increase/decrease it as wanted)   
...
rmpath('C:\Users\Emertat\Documents\cooldisk\Matlab\Code\MS_AR_FEX\MS_AR_FEX');